...
FORM: brief-pinned competitor-like Operate surface; code-led implementation to meet the requested run-first stages, not a new visual identity exercise. Signature interaction: a changed path opens in the real editor while preserving the agent session.
